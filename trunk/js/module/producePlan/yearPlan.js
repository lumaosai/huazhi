require([cdnDomain+'/js/zlib/app.js'], function (App) {
    var PageModule = {
        ...
        yearPLInit: function () {
            ...
            window.pageLoad = function () {
                ...
                require(['Page'], function () {
                    new Page().init(Const.aps + "/api/aps/ApsYearPlan/page", data, true, function (tableDate) {
                        ...
                        $(".btn-delete").click(function () {
                            ...
                            Bus.deleteItem('确定要删除该计划', Const.aps + '/api/aps/ApsYearPlan/delete', {ids:id});
                        });
                        //编辑
        ...
        //获取状态数据
        loadStatus: function () {
            var url_ = Const.admin + '/api/sys/SysDict/type/yearPlanStatus';
            ...
            require(['easyui_my'],function(easyui){
                ...
                $(function () {
                    ...
                    $('.btn-export').click(function () {
                        window.location.href = Const.aps + '/aps/PlanExport/yearPlanExport?id=' + id;
                    });
                });
                var data = {
                    id: id
                };
                Api.ajaxJson(Const.aps + "/api/aps/ApsYearPlan/queryYearPlan", JSON.stringify(data), function (result) {
                    if (result.success) {
                        ...
                        if(result.Template.jsonCfg == ''){
                            return
                        }
                        var jsonCfg = JSON.parse(result.Template.jsonCfg);
                        var ii = 0;
                        for (var i = 0; i < len; i++) {
        ...
        postData: function (easyui,status) {
            ...
            function ajaxData() {
                ...
                Api.ajaxForm(Const.aps + "/api/aps/ApsYearPlan/saveYearInfo", data, function (result) {
                    if (result.success) {
        ...
        yearPLCompareInit: function () {
            ...
            Api.ajaxJson(Const.aps + '/api/aps/MonthPcSc/form', JSON.stringify(data1), function (result) {
                if (result.success) {
                    ...
                    if (data) {
                        ...
                        if (len) {
                            ...
                            require(['artTemplate'], function (template) {
                                var html = template('j-specCard', obj);
                                $('#tab').html(html);
                                ...
                                PageModule.operationTab(function (newArr) {
                                    ...
                                    $(".btn-save").unbind('click').click(function () {
                                        ...
                                        newArr = []; // 重新赋值为空
                                        Api.ajaxForm(Const.aps + "/api/aps/MonthPcSc/save", data, function (result) {
                                            if (result.success) {
                                                top.layer.msg('操作成功，即将返回月计划列表页！', {
                                                    icon: 1,
                                                    time: 500
