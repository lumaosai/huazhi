    ...
    var PageModule = {
        ...
        KeyWorkPVInit:function(){
            require(['easyui_my'], function (easyui) {
                ...
                Api.ajaxForm(Const.aps + "/api/aps/ApsMonthAdjustZdgz/queryMonthAdjustZdgz?mainId=" + id, {}, function (result) {
                    if (result.success) {
        ...
        KeyWorkPVEInit:function () {
            require(['easyui_my'], function (easyui) {
                ...
                function deleteDateRow() {
                    ...
                    if (ids.length > 0) {
                        ...
                        Mom.layConfirm("确认要删除吗？", function (layIndex, layero) {
                            //    删除接口
                            Api.ajaxForm(Const.aps + "/api/aps/ApsMonthAdjustZdgz/delete", {ids: ids}, function (result) {
                                if(result.success){
                                    Api.ajaxForm(Const.aps + "/api/aps/ApsMonthAdjustZdgz/queryMonthAdjustZdgz?mainId=" + id, {}, function (res) {
                                        if (res.success) {
                ...
                function postData() {
                    ...
                    Api.ajaxForm(Const.aps + "/api/aps/ApsMonthAdjustZdgz/updateBreakingNews", data, function (result) {
                        //编辑保存接口
                        if (result.success) {
                            top.layer.msg('保存成功!', {
                                icon: 1,
        ...
        keyPlanAddInit:function () {
            require(['easyui_my'], function (easyui) {
                $('#inputForm').attr('action', Const.aps + '/api/aps/ApsMonthAdjustZdgz/saveBreakingNews');
                ...
                function getDataGrid() {
                    Api.ajaxForm(Const.aps + '/api/aps/ApsMonthAdjustZdgz/queryMonthAdjustZdgzToAdd', {}, function (result) {
                        if (result.success) {
                            //获取单位集合
