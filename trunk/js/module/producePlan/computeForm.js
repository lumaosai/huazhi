    ...
    var PageModule = {
        ...
        computeFormInit: function () {
            ...
            require(['Page'], function () {
                new Page().init(Const.aps + "/api/aps/Formula/page", {}, true, function(rows, result) {
                    if (rows) {
                        ...
                        $('.btn-delete').click(function () {
                            var id = $(this).parents("tr").find("td:first").text();
                            Bus.deleteItem('确定要删除该配置吗', Const.aps + '/api/aps/Formula/delete', {ids:id});
                        });
                    } else {
        ...
        computeztreeInit: function () {
            ...
            if (id) {
                $("#objId").val(id);
                Api.ajaxForm(Const.aps + "/api/aps/Formula/form/" + id, {}, function (result) {
                    if (result.success) {
            ...
            Api.ajaxJson(Const.aps + '/api/aps/Dict/tree', {}, function (result) {
                if (result.success) {
