        ...
        proSafeEPInit:function(){
            require(['easyui_my'], function (easyui) {
                ...
                function getmsg(dateyear) {
                    ...
                    Api.ajaxJson(Const.aps + "/api/aps/ApsMonthAdjustAqhbjh/queryMonthAdjustAqhbjh", JSON.stringify(data), function (result) {
                        if (result.success) {
        ...
        proSafeEPEInit:function () {
            require(['easyui_my'], function (easyui) {
                ...
                function submitData(status) {
                    ...
                    Api.ajaxForm(Const.aps + "/api/aps/ApsMonthAdjustAqhbjh/saveAqhbjhInfo", data, function (result) {
                        if (result.success) {
