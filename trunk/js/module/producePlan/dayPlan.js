require([cdnDomain+'/js/zlib/app.js'], function (App) {
    ...
    var PageModule = {
            ...
            dayPlanList: function () {
                ...
                window.pageLoad = function () {
                    ...
                    require(['Page'], function () {
                        new Page().init(Const.aps + "/api/aps/DayPlan/page", data, true, function (tableData, result) {
                            ...
                            $(".btn-delete").click(function () {
                                ...
                                Bus.deleteItem('确定要删除该计划', Const.aps + '/api/aps/DayPlan/delete', {ids:id});
                            });
                            //编辑
            ...
            dayPlanEdit: function () {
                require(['easyui_my'], function (easyui) {
                    var id = Mom.getUrlParam('id') || "",
                        ...
                        monthId = '';
                    Api.ajaxForm(Const.aps + '/api/aps/DayPlan/dayPlanMonthSelect', {}, function (result) {
                        if (result.success) {
                    ...
                    $("#monthName,#apsWeek").on('change', function () {
                        ...
                        PageModule.getDataFn(function (dpYear, dpMonth, dpWeek) {
                            if (dpYear != "" && dpWeek != "") {
                                ...
                                Api.ajaxJson(Const.aps + "/api/aps/DayPlan/form", data, function (result) {
                                    if (result.success) {
                                        if (result.signFlag) {
            ...
            tabledatagrid: function (dpYear, dpMonth, dpWeek, easyui) {
                ...
                Api.ajaxJson(Const.aps + "/api/aps/DayPlan/form", JSON.stringify(data), function (result) {
                    if (result.success) {
                        PageModule.checkDGArr = [];
                        var ii =0;
                        var len = result.rows.length>0?result.rows.length:0;
                        if(result.Template.jsonCfg == '') return;
            ...
            submitData: function (status, easyui) {
                ...
                Api.ajaxForm(Const.aps + '/api/aps/DayPlan/save', data, function (result) {
                    if (result.success) {
                        Mom.layMsg('提交成功');
                        Mom.winBack();
                    } else {
            ...
            dayPlanView: function () {
                require(['easyui_my'], function (easyui) {
                    ...
                    $('.btn-export').click(function () {
                        window.location.href = Const.aps + '/aps/PlanExport/dayPlanExport?id=' + id + '&dpYear=' + dpYear + '&dpMonth=' + dpMonth + '&dpWeek=' + dpWeek;
                    });
                });
            },
            //多表格请求数据渲染方法
