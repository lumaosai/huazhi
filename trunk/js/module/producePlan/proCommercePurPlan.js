        ...
        proCPPInit:function(){
            require(['easyui_my'], function (easyui) {
                ...
                function getmsg() {
                    ...
                    Api.ajaxJson(Const.aps + "/api/aps/ApsMonthAdjustBus/queryMonthAdjustBus", JSON.stringify(data), function (result) {
                        if (result.success) {
        ...
        proCPPEInit:function () {
            require(['easyui_my'], function (easyui) {
                ...
                function submitData(status) {
                    ...
                    Api.ajaxForm(Const.aps + "/api/aps/ApsMonthAdjustBus/saveBusInfo", data, function (result) {
                        if (result.success) {
