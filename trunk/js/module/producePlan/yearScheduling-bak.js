require([cdnDomain+'/js/zlib/app.js'], function (App) {
    var PageModule = {
        ...
        initData: function (id) {
            ...
            Api.ajaxForm(Const.aps + "/api/aps/ApsYearPlan/getYearValue", data, function (result) {
                ...
                if ($scValue !== "" && $psValue !== "") {
                    ...
                    if (pcId) {
                        ...
                        url = Const.aps + '/api/aps/ApsMonthPc/queryMonthPc';
                        ...
                        url = Const.aps + '/api/aps/ApsMonthPc/pcJs';
                    ...
                    $("#btn-save").click(function () {
                        ...
                        Mom.layConfirm("确认提交吗?", function () {
                            Api.ajaxForm(Const.aps + "/api/aps/ApsMonthPc/saveMonthInfo", data, function (result) {
                                if (result.success) {
                                    Mom.winBack();
                                }
                            });
        ...
        tableEventBind: function () {
            ...
            $("#td0 thead th i").click(function () {
                ...
                //保存
                    ...
                    //计算数据接扣
                    Api.ajaxJson(Const.aps + "/api/aps/ApsMonthPc/dtpcJs", data_, function (result) {
                        if (result.success == true) {
                            ...
                            top.layer.confirm(str + ' 确定吗？', {icon: 3, title: '系统提示'}, function (index, layero) {
                                ...
                                Api.ajaxForm(Const.aps + '/api/aps/ApsMonthPc/saveDtpcJs', saveData, function (result) {
                                    if (result.success) {
        ...
        hidebutton: function () {
            ...
            if (status == "2") {
                ...
                var url = Const.admin + "/api/sys/SysOperation/currentUserOperation/PPMYPP_PAC";
