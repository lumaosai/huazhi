require([cdnDomain+'/js/zlib/app.js'], function(App) {
    var PageModule = {
        listInit: function(){
            ...
            require(['Page'],function(){
                window.pageLoad = function (){
                    ...
                    //修改默认每页显示条数
                    var page = new Page();
                    page.init(Const.admin+"/api/sys/SysApplication/page",data,true,function(tableData){
                        ...
                        $('.btn-delete').click(function(){
                            var id = $(this).parents("tr").find('.i-checks').attr('id');
                            Bus.deleteItem('确定要删除该应用吗',Const.admin+'/api/sys/SysApplication/delete',{ids:id});
                        });
                        //点击重置按钮
        ...
        formInit: function(){
            ...
            $("#value").focus();
            if(id){
                var url = Const.admin+"/api/sys/SysApplication/"+api+"/"+id;
