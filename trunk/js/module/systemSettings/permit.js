require([cdnDomain+'/js/zlib/app.js'], function(App) {
    var PageModule = {
        listInit: function(){
            ...
            require(['Page'],function(){
                ...
                window.pageLoad = function (){
                    ...
                    //修改默认每页显示条数
                    page.init(Const.admin+"/api/sys/SysPermission/page",data,true,function(tableData, result){
                        ...
                        $('.btn-delete').click(function(){
                            var id = $(this).parents("tr").find('.i-checks').attr('id');
                            Bus.deleteItem('确定要删除该许可吗',Const.admin+'/api/sys/SysPermission/delete',{ids:id});
                        });
        ...
        formInit: function(){
            ...
            var url = Const.admin+"/api/sys/SysPermission/"+api+"/"+id;
        ...
        permitAuthData: function(){
            ...
            var id = Mom.getUrlParam('id');
            $("#permissionId").val(id);
            Api.ajaxJson(Const.admin+'/api/sys/SysPermission/authData/'+id,{},function(result) {
                if (result.success) {
                    ...
                    require(['ztree_my'],function(ZTree) {
                        ...
                        $('#permitAuthZtree').change(function(){
                            ...
                            url = Const.admin+"/api/sys/SysPermission/listPropVal/"+objectId+"/"+val;
                            ...
                            function onDblClick(event, treeId, treeNode){
                                if(treeNode){
                                    var id = treeNode.id;
                                    var url = Const.admin+"/api/sys/SysAuthPropertyValue/perimissionview/"+id;
                                    Api.ajaxJson(url,{},function(result){
                                        if(result.success){
