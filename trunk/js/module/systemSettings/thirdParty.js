require([cdnDomain+'/js/zlib/app.js'], function(App) {
    var PageModule = {
        listInit: function(){
            ...
            require(['Page'],function(){
                window.pageLoad = function (){
                    ...
                    //修改默认每页显示条数
                    var page = new Page();
                    page.init(Const.admin+"/api/sys/SysUserRel/page",data,true,function(tableData, result){
                        ...
                        $('.btn-delete').click(function(){
                            var id = $(this).parents("tr").find('.i-checks').attr('id');
                            Bus.deleteItem('确定要删除该用户吗',Const.admin+'/api/sys/SysUserRel/delete/',{ids:id});
                        });
                        //重置按钮
        ...
        formInit: function(){
            ...
            var url = Const.admin+"/api/sys/SysUserRel/form/"+id;
