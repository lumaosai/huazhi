require([cdnDomain+'/js/zlib/app.js'], function(App) {
    var PageModule = {
        listInit: function(){
            ...
            require(['Page'],function(){
                ...
                window.pageLoad = function (){
                    ...
                    //修改默认每页显示条数
                    page.init(Const.admin+"/api/sys/SysOperation/page",data,true,function(tableData, result){
                        ...
                        $('.btn-delete').click(function () {
                            var id = $(this).parents("tr").find('.i-checks').attr('id');
                            Bus.deleteItem('确定要删除该属性吗', Const.admin+'/api/sys/SysOperation/delete',{ids:id});
                        });
                    });
                };
                //点击重置按钮
        ...
        formInit: function(){
            ...
            $("#value").focus();
            if(id){
                var url = Const.admin+"/api/sys/SysOperation/"+api+"/"+id;
