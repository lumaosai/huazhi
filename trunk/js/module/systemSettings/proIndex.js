    ...
    var PageModule = {
        listInit: function(){
            ...
            require(['Page'],function(){
                ...
                window.pageLoad = function (){
                    ...
                    //修改默认每页显示条数
                    page.init(Const.admin+"/api/sys/SysAuthProperty/page",data,true,function(tableData, result){
                        dataout(tableData);
                        ...
                        $('.btn-delete').click(function () {
                            var id = $(this).parents("tr").find('.i-checks').attr('id');
                            Bus.deleteItem('确定要删除该属性吗', Const.admin+'/api/sys/SysAuthProperty/delete',{ids:id});
                        });
        ...
        proCheckView: function(){
            ...
            if (id) {
                ...
                var url = Const.admin+"/api/sys/SysAuthProperty/view/" + id;
