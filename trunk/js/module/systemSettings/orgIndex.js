    ...
    var PageModule = {
        listInit: function(){
            ...
            require(['ztree_my','easyui_my'],function(ZTree, easyuiObj){
                ...
                // 加载右侧数据
                function load(node) {
                    Api.ajaxJson(Const.admin+"/api/sys/SysOrg/treeJson/"+node,{},function(tableData){
                ...
                function btncilck(){
                    ...
                    $('.btn-delete').unbind('click').click(function () {
                        ...
                        Bus.deleteItem('确定要删除该机构吗', Const.admin+'/api/sys/SysOrg/del/',data, deleteCallback);
                    });
                    // 添加下级
        ...
        formInit: function(){
            // 获取机构类型
            Bus.createSelect(Const.admin+"/api/sys/SysDict/type/orgType","#type");
            // 获取机构等级
            Bus.createSelect(Const.admin+"/api/sys/SysDict/type/orgGrade","#grade");
            ...
            if (id!==null) {
                ...
                var url = Const.admin+"/api/sys/SysOrg/view/" + id;
                ...
                var url = Const.admin+"/api/sys/SysOrg/view/" + pid;
                Api.ajaxForm(url, {}, function (result) {
                    if (result.success) {
                        var SysOrg = result.SysOrg;
