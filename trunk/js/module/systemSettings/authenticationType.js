require([cdnDomain+'/js/zlib/app.js'], function(App) {
    var PageModule = {
        listInit: function(){
            ...
            require(['Page'],function(){
                ...
                window.pageLoad = function (){
                    ...
                    //修改默认每页显示条数
                    page.init(Const.admin+"/api/sys/SysAuthClass/authClassPage",data,true,function(tableData){
                        ...
                        $('.btn-delete').click(function(){
                            var id = $(this).parents("tr").find('.i-checks').attr('id');
                            Bus.deleteItem('确定要删除该鉴权类吗',Const.admin+'/api/sys/SysAuthClass/delete',{ids:id});
                        });
        ...
        formInit: function(){
            ...
            var url = Const.admin+"/api/sys/SysAuthClass/"+api+"/"+id;
        ...
        listInitPro: function(){
            ...
            require(['Page'],function(){
                window.pageLoad = function (){
                    ...
                    var page = new Page();
                    page.pageShowNum = 0;
                    page.init(Const.admin+"/api/sys/SysAuthClass/authPropertyPage",data,true,function(tableData){
                        renderTableDataPro(tableData);
                        $('#allot-btn').click(function(){
                            allotCancelItem("#treeTable","dist","是",Const.admin+"/api/sys/SysAuthClass/ajaxSaveDist");
                        });
                        $('#cancel-btn').click(function(){
                            allotCancelItem("#treeTable","cancel","否",Const.admin+"/api/sys/SysAuthClass/ajaxSaveDist");
                        });
                        //点击重置按钮
                        $('#reset-btn').click(function(){
                            $("#authProName").val("");
