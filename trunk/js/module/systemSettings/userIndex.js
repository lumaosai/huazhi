    ...
    var PageModule = {
            ...
            require(['ztree_my','Page'],function(ZTree){
                ...
                function clickButton() {
                    $('.btn-check').click(function () {
                        ...
                        Bus.openDialog('查看用户信息', './systemSettings/userIndexInner.html?id=' + id, '990px','540px');
                    });
                    $('.btn-change').click(function () {
                        var id = $(this).parents("tr").find('.i-checks').attr('id');
                        Bus.openEditDialog('修改用户信息', './systemSettings/userIndexInner.html?id=' + id, '990px','540px');
                    });
                    $('.btn-delete').click(function () {
                        var id = $(this).parents("tr").find('.i-checks').attr('id');
                        Bus.deleteItem('确定要删除该用户吗',Const.admin+'/api/sys/SysUser/delete/',{ids:id});
                    });
                }
            });
        ...
        formInit: function(){
            ...
            if (id) {
                ...
                var url = Const.admin+"/api/sys/SysUser/form/"+id;
                ...
                var url = Const.admin+"/api/sys/SysUser/form/-1";
                Api.ajaxJson(url, {}, function (result) {
                    if(result.success){
                        // 所属岗位
                        var jobTypeList = result.jobTypeList;
