    ...
    var PageModule = {
        proPreserveValue: function(){
            ...
            require(['ztree_my','easyui_my'],function(ZTree,easyuiObj){
                ...
                Api.ajaxJson(Const.admin+'/api/sys/SysAuthPropertyValue/list/'+propId,{},function(result){
                    if(result.success){
                        var ztreeSetting = {
                            callback:{
                ...
                function loadTreeTable(data){
                    var url = Const.admin+"/api/sys/SysAuthPropertyValue/ajaxTreeJson";
                    // url = Const.aps + "/api/aps/Device/ajaxTreeJson/0";
                ...
                function clickButton() {
                    ...
                    $('.btn-delete').click(function () {
                        var id = $(this).attr('id');
                        Bus.deleteItem('确定要删除该属性吗', Const.admin+'/api/sys/SysAuthPropertyValue/ajaxDel/'+id,{},function (result,layerIndex) {
                            if(result.success == true){
        ...
        proValueCheckView: function(){
            ...
            if (id) {
                ...
                var url = Const.admin+"/api/sys/SysAuthPropertyValue/form";
