        ...
        init: function () {
            ...
            require(['Page'], function () {
                ...
                window.pageLoad = function () {
                    ...
                    //修改默认每页显示条数
                    new Page().init(Const.aps + "/api/ob/OreBlendingCase/page", data, true, function (result) {
                ...
                if (str.length > 0) {
                    for (var j = 0; j < arr.length; j++) {
                        if (arr[j] == "已封存") {
                            ...
                            //
                            Api.ajaxForm(Const.aps + "/api/ob/OreBlendingCase/updateStatus", data, function (result) {
                                if (result.success) {
                                    PageModule.init();
                                } else {
                ...
                top.layer.confirm('请您确认是否要删除勾选数据', {icon: 3, title: '系统提示'}, function (index) {
                    ...
                    if (bol) {
                        if (str.length > 0) {
                                ...
                                var url = Const.aps + '/api/ob/OreBlendingCase/delete';
