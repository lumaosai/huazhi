...
require([cdnDomain+'/js/zlib/app.js'], function (App) {
    var PageModule = {
        deviceBoundaryArea: function(){
            ...
            require(['Page'], function () {
                ...
                window.pageLoad = function () {
                    ...
                    //修改默认每页显示条数
                    page.init(Const.mtrl + "/api/fm/AreaUnit/page", data, true, function (tableData) {
                        ...
                        $('.btn-delete').click(function () {
                            var id = $(this).parents("tr").find('.i-checks').attr('id');
                            Bus.deleteItem('确定要删除该装置界区吗', Const.mtrl + '/api/fm/AreaUnit/del/', {ids:id});
                        });
                    });
                };
        ...
        deviceBoundaryAreaView: function() {
            ...
            Api.ajaxJson(Const.mtrl + "/api/fm/AreaUnit/form/" + id,{},function(result){
                if(result.success){
