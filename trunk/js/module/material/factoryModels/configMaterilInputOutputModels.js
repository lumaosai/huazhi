...
require([cdnDomain+'/js/zlib/app.js'], function (App) {
    var PageModule = {
        ...
        //加载数据 左上列表 右上列表 下拉选项
        loadData:function(){
            Api.ajaxJson(Const.mtrl + '/api/fm/MtrlInoutput/form/0',{},function (result) {
                if(result.success){
                    //工厂
        ...
        createList1:function (data) {
            ...
            $("#list1").on("click","li",function () {
                ...
                Api.ajaxJson(Const.mtrl +"/api/fm/MtrlInoutput/findList",data,function (result) {
                    if(result.success){
        ...
        clickHandler:function () {
            ...
            $("#btn-save").unbind("click").on("click",function(){
                ...
                Api.ajaxForm(Const.mtrl + "/api/fm/MtrlInoutput/save" ,data,function(result){
                    if(result.success){
                        Mom.layMsg("保存成功")
                    }
                })
