...
require([cdnDomain+'/js/zlib/app.js'], function (App) {
    var PageModule = {
        ...
        init:function () {
            ...
            //加载运输类型数据
            PageModule.loadData(Const.mtrl + "/api/fm/TransGauge/getTypes");
            //加载物料数据
            //var material = {};
            //PageModule.loadData(Const.adminDev + "/warehouse.json",warehouse);
        ...
        createList1:function (data,item) {
            ...
            $("#list1").on("click","li",function () {
                ...
                Api.ajaxForm(Const.mtrl +"/api/fm/TransGauge/queryGaugeList/"+PageModule.list1Id,{},function (result) {
                    if(result.success){
        ...
        clickHandler:function () {
            ...
            $("#btn-save").unbind("click").on("click",function(){
                ...
                Api.ajaxForm(Const.mtrl+'/api/fm/TransGauge/saveConfigGauge',data,function(result){
                    if(result.success){
                        Mom.layMsg("保存成功")
                    }
                })
