...
require([cdnDomain+'/js/zlib/app.js'], function (App) {
    var PageModule = {
        listInit: function () {
            //动态添加Select的option
            //物料类型
            Bus.createSelect(Const.admin + '/api/sys/SysDict/type/MTRL_TYPE', "#mtrlType", 'value', 'label');

            //vcf类型
            Bus.createSelect(Const.admin + "/api/sys/SysDict/type/VCF_TYPE", "#vcfType", 'value', 'label');
            ...
            require(['Page'], function () {
                window.pageLoad = function () {
                    ...
                    var page = new Page();
                    page.init(Const.mtrl +'/api/fm/Mtrl/page', data, true, function (tableData) {
                        ...
                        $('.btn-delete').click(function () {
                            var id = $(this).parents("tr").find('.i-checks').attr('id');
                            Bus.deleteItem('确定要删除该物料吗', Const.mtrl + '/api/fm/Mtrl/delete/', {ids:id});
                        });
                    });
        ...
        formInit: function () {
            ...
            var url = Const.mtrl + '/api/fm/Mtrl/form/'+id;
