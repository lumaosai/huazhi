...
require([cdnDomain+'/js/zlib/app.js'], function (App) {
    var PageModule = {
        listInit: function () {
            //新增下拉数据
            //工厂
            Bus.createSelect(Const.mtrl + '/api/fm/Fctr/fctrSelect', "#fctrId", 'id', 'fctrName');
            //物料
            Api.ajaxJson(Const.mtrl + '/api/fm/Mtrl/list',JSON.stringify({}),function(result){
                if(result.success){
                    //var list = [];
            ...
            //Bus.createSelect(Const.mtrl + '/api/fm/Mtrl/list', "#fctrId", 'id', 'fctrName');
            //新增=
            ...
            require(['Page'], function () {
                ...
                window.pageLoad = function () {
                    ...
                    page.init(Const.mtrl +'/api/fm/InoutputModel/page', data, true, function (tableData) {
                        ...
                        $('.btn-delete').click(function () {
                            var id = $(this).parents("tr").find('.i-checks').attr('id');
                            Bus.deleteItem('确定要删除该投入产出模型配置吗', Const.mtrl + '/api/fm/InoutputModel/delete', {ids:id});
                        });
                    });
                };
                //搜索
        ...
        * */
        ...
        formInit: function () {
            ...
            var url = Const.mtrl +'/api/fm/InoutputModel/form/' + id;
