...
require([cdnDomain+'/js/zlib/app.js'], function (App) {
    ...
    var PageModule = {
        ...
        //加载数据 左上列表 右上列表 下拉选项
        loadData:function(){
            Api.ajaxJson(Const.mtrl + '/api/fm/SlineTank/form/0',{},function (result) {
                if(result.success){
                    //工厂
        ...
        loadList1Data:function(){
            ...
            Api.ajaxJson(Const.mtrl + '/api/fm/NodeSideline/list',data,function (result) {
                if(result.success){
        ...
        loadList2Data:function(){
            ...
            Api.ajaxJson(Const.mtrl + '/api/fm/NodeTank/findSiloListByFctr',data,function (result) {
                if(result.success){
        ...
        createList1:function (data,item) {
            ...
            $("#list1").on("click","li",function () {
                ...
                Api.ajaxJson(Const.mtrl +"/api/fm/SlineTank/findList",data,function (result) {
                    if(result.success){
        ...
        clickHandler:function () {
            ...
            $("#btn-save").unbind("click").on("click",function(){
                ...
                Api.ajaxForm(Const.mtrl + "/api/fm/SlineTank/save" ,data,function(result){
                    if(result.success){
                        Mom.layMsg("保存成功")
                    }
                })
