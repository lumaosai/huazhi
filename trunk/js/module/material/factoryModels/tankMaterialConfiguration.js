...
require([cdnDomain+'/js/zlib/app.js'],function (app) {
    var PageModule = {
        ...
        init:function () {
            ...
            Api.ajaxJson(Const.mtrl + "/api/fm/MtrlTank/form/0",{},function (result) {
                if(result.success){
            ...
            //加载罐数据
             function tankLoad(){
                 ...
                 PageModule.loadData(Const.mtrl + "/api/fm/NodeTank/findListByFctr",JSON.stringify(data),"warehouse");
             }
            tankLoad();
            //加载罐物料
            function tankMaterialLoad(){
                ...
                PageModule.loadData(Const.mtrl + "/api/fm/MtrlFctr/findListByFctr",JSON.stringify(data),"advocate");
            }
            tankMaterialLoad();
            ...
            $('.btn-save').unbind('click').on('click',function(){
                ...
                var data = {
                    ...
                    Api.ajaxForm(Const.mtrl + "/api/fm/MtrlTank/save",data,function (result) {
                        if(result.success){
                            Mom.layMsg(result.message);
                        }else{
                            Mom.layMsg(result.message);
        ...
        //创建罐列表
         createList:function (data,item) {
            ...
            $("."+item+" li").click(function () {
                ...
                Api.ajaxJson(Const.mtrl + "/api/fm/MtrlTank/findList",JSON.stringify(data),function (result) {
                    if(result.success){
                        var data = result.rows;
