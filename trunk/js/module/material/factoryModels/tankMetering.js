...
require([cdnDomain+'/js/zlib/app.js'], function (App) {
    var PageModule = {
        listInit: function () {
            //一些下拉数据
            //计量类型
            Bus.createSelect(Const.admin + '/api/sys/SysDict/type/GAUGE_TYPE', "#measType", 'value', 'label');
            ...
            require(['Page'], function () {
                window.pageLoad = function () {
                    ...
                    var page = new Page();
                    page.init(Const.mtrl +'/api/fm/TankMeas/page', data, true, function (tableData) {
                        ...
                        $('.btn-delete').click(function () {
                            var id = $(this).parents("tr").find('.i-checks').attr('id');
                            Bus.deleteItem('确定要删除该罐计量吗', Const.mtrl + '/api/fm/TankMeas/delete', {ids:id});
                        });
                    });
                };
                //搜索
        ...
        formInit: function () {
            ...
            var url = Const.mtrl + '/api/fm/TankMeas/form/'+id;
