...
require([cdnDomain+'/js/zlib/app.js'], function (App) {
    var PageModel = {
        init:function () {
            ...
            require(["Page"],function () {
                ...
                window.pageLoad = function () {
                    ...
                    page.init(Const.mtrl+"/api/fm/AreaTank/page",data,true,function (result) {
                        ...
                        $(".btn-delete").click(function () {
                            var id = $(this).parents("tr").find('.i-checks').attr('id');
                            Bus.deleteItem('确定要删除该罐区', Const.mtrl + '/api/fm/AreaTank/del',{ids:id});
                        });
                        //点击重置按钮
        ...
        checkInit:function () {
            ...
            Api.ajaxForm(Const.mtrl+"/api/fm/AreaTank/form/"+id,{},function (result) {
                if(result.success){
