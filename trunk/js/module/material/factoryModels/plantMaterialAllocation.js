        ...
        plantMaterialAllocation: function(){
            function load() {
                require(['ztree_my'],function(ZTree){
                    ...
                    Api.ajaxForm(Const.mtrl + "/api/fm/MtrlFctr/form/"+id, data, function (da) {
                        if(da.success){
                            var ztreeSetting1 = {
                                edit: {
                                    enable:true,
                            ...
                            $('#btn-search').click(function(){
                                ...
                                Api.ajaxJson(Const.mtrl + "/api/fm/MtrlFctr/getTree", JSON.stringify(data), function (data) {
                                    if(data.success){
                            ...
                            $('#btn-save').unbind().click(function(){
                                ...
                                Api.ajaxForm(Const.mtrl + "/api/fm/MtrlFctr/save",data, function (res) {
                                    if(res.success){
