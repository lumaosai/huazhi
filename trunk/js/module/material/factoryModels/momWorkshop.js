...
require([cdnDomain+'/js/zlib/app.js'], function (App) {
    var PageModule = {
        momWorkshop: function(){
            ...
            require(['Page'], function () {
                ...
                window.pageLoad = function () {
                    ...
                    page.init(Const.mtrl + "/api/fm/Workshop/page", data, true, function (tableData) {
                        ...
                        $('.btn-delete').click(function () {
                            var id = $(this).parents("tr").find('.i-checks').attr('id');
                            Bus.deleteItem('确定要删除改MOM车间吗', Const.mtrl + '/api/fm/Workshop/delete/', {ids:id});
                        });
                        //编辑
        ...
        momWorkshopView: function() {
            ...
            if(id){
                    Api.ajaxJson(Const.mtrl + "/api/fm/Workshop/form/" + id,{},function(result){
                        if(result.success){
                ...
                Api.ajaxJson(Const.mtrl + "/api/fm/Workshop/form/0",{},function(result){
                    if(result.success){
                        Bus.appendOptionsValue('#fctr',result.fctrList,'id','fctrName');
                    }
                });
