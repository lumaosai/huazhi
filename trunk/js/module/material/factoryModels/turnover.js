...
require([cdnDomain+'/js/zlib/app.js'], function (App) {
    var PageModel = {
        init:function () {
            ...
            //进出厂类型下拉
            Api.ajaxJson(Const.admin + "/api/sys/SysDict/type/"+"INOUT_TYPE",{},function(result){
            ...
            require(["Page"],function () {
                ...
                window.pageLoad = function () {
                    ...
                    page.init(Const.mtrl+"/api/fm/NodeInoutput/page",data,true,function (result) {
                        ...
                        $(".btn-delete").click(function () {
                            var id = $(this).parents("tr").find('.i-checks').attr('id');
                            Bus.deleteItem('确定要删除信息', Const.mtrl + '/api/fm/NodeInoutput/del',{ids:id});
                        });
                        //点击重置按钮
        ...
        measuringNodeCInit: function () {
            ...
            Api.ajaxJson(Const.mtrl+"/api/fm/NodeInoutput/form/"+id,{},function (result){
            ...
            require(['/js/module/material/factoryModels/computedCommons.js'], function (computed) {
                ...
                computed.com_renderChange('.contentBox.active', '.contentBox', '.contentChange>li',Const.mtrl+'/api/fm/Formula/instrumentAndFunc', PageModel.btnComputed);
            })
        },
        //计算公式按钮区
        btnComputed: function () {
            ...
            $(thisbox).find('.btn-save').unbind('click').on('click', function () {
                ...
                Api.ajaxJson(Const.mtrl+'/api/fm/NodeInoutput/updateFormula',JSON.stringify(data),function (result) {
                    if(result.success){
                        Mom.layMsg('保存成功')
                    }else{
        ...
        checkInit:function () {
            var id = Mom.getUrlParam("id");
            Api.ajaxForm(Const.mtrl+"/api/fm/NodeInoutput/form/"+id,{},function (result) {
                if(result.success){
