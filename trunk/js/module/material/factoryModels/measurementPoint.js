require([cdnDomain+'/js/zlib/app.js'], function (App) {
    ...
    var PageModule = {
        ...
        measurementPointListInit: function () {
            Api.ajaxJson(Const.mtrl+'/api/fm/Fctr/fctrSelect',{},function (result) {
            ...
            Bus.createSelect(Const.admin+'/api/sys/SysDict/type/MTRL_TYPE','#mtrlType');
            require(['Page'], function (){
                ...
                window.pageLoad = function () {
                    ...
                    page.init(Const.mtrl + "/api/fm/Instrument/page", data, true, function (tableData,result) {
        ...
        btngather: function (page) {
            ...
            $('.btn-delete').unbind('click').click(function () {
                var id = $(this).parents("tr").find('.i-checks').attr('id');
                Bus.deleteItem('确定要删除该测量点吗', Const.mtrl + '/api/fm/Instrument/delete', {ids:id});
            });
            //点击重置按钮
        ...
        measurementPointFormInit: function () {
            ...
            Api.ajaxJson(Const.mtrl + "/api/fm/Instrument/form/"+id, {}, function (result) {
                if (result.success) {
