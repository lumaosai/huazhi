...
require([cdnDomain+'/js/zlib/app.js'], function (App) {
    var PageModule = {
        ...
        loadList1Data:function(){
            ...
            Api.ajaxJson(Const.mtrl + '/api/fm/Node/queryNodeInfo',JSON.stringify(data),function(result){
        ...
        createList1:function (data) {
            ...
            $("#list1").on("click","li",function () {
                ...
                Api.ajaxForm(Const.mtrl +"/api/fm/MtrlMoveModel/queryAimNodeList/"+PageModule.list1Id,{},function (result) {
                    if(result.success){
                        var dataList = [];
        ...
        clickHandler:function () {
            ...
            $('#btn-save').unbind('click').on('click',function () {
                ...
                Api.ajaxForm(Const.mtrl+'/api/fm/MtrlMoveModel/saveAimNode',data,function (result) {
                    if(result.success){
                        Mom.layMsg('保存成功');
                        console.log(result)
                    }else{
