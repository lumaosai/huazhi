    ...
    var PageModule = {
        init: function(){
            require(['jqGrid_my'], function (jqGridAll) {
                ...
                Api.ajaxJson(Const.mtrl+"/api/mv/SmtinoutBill/getTypeSel", {}, function (result) {
                    if(result.success){
                        ...
                        Api.ajaxJson(Const.mtrl+"/api/mv/SmtinoutBill/mtrlInoutputList", JSON.stringify(data), function (res) {
                            if(res.success){
                ...
                window.pageLoad = function (data) {
                    ...
                    Api.ajaxJson(Const.mtrl+"/api/mv/SmtinoutBill/instrList", JSON.stringify(dataList), function (res) {
                        if(res.success){
                            ...
                            var subtable =[];
                            jqGridAll.jG_jqGridTableLevel('#SmtinoutBill',optionsPot,optionsMMove,config,subtable,false,1);
                        }else{
