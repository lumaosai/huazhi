    ...
    var PageModule = {
        ...
        renderPotTable: function (potArr, moveArr, result) {
            require(['jqGrid_my'], function (jqGridAll) {
                ...
                var config = {
                    url: Const.mtrl + '/api/mv/TankMtrlMove/list/' + data.id,
                    dataParams: {
                        id: '470dca52dbeb45288afb4769a33b6226',/**/
                        date: '2018-10-22',/**/
                        shift: '00:00:00-22:00:00'/**/
        ...
        addMoveInit: function () {
            ...
            require(['Page'], function () {
                ...
                if (moveId == null && potId != null) {
                    //初始化是否可编辑项
                    tankMove(Const.mtrl+'/api/mv/TankMtrlMove/form/'+potId, 'table tr td', '#operationType,#oppositeNode,#oppositeMaterial,#startTime', '#startTime', true);
                    /*初始化对方节点*/
                    nodeToMtrl(Const.mtrl+'/api/mv/TankMtrlMove/form/'+potId,Const.mtrl+'/api/mv/TankMtrlMove/getListByType', '#oppositeNode', '#oppositeMaterial', '#oppositealias', true);
                    openVal('.dlvVal');
                    $('#operationType').on('change', function () {
                        ...
                        if (moveTypeS == 'TANK_TO_TANK') {
                            ...
                            tankMove(Const.mtrl+'/api/mv/TankMtrlMove/form/'+potId, 'table tr td', '#operationType,input:checkbox,#oppositeNode,#startTime', '#startTime', false);
                            /*初始化对方节点*/
                            nodeToMtrl(Const.mtrl+'/api/mv/TankMtrlMove/form/'+potId,Const.mtrl+'/api/mv/TankMtrlMove/getListByType', '#oppositeNode', '#oppositeMaterial', '#oppositealias', true);
                            /*本方量对方量 检尺回显方法*/
                            openVal('.dlvVal');
                        ...
                        //罐收付进出厂点
                            ...
                            //初始化是否可编辑项
                            tankMove(Const.mtrl+'/api/mv/TankMtrlMove/form/'+potId, 'table tr td', '#operationType,input:checkbox,#oppositeNode,#oppositeMaterial,#startTime', '#startTime', false);
                            /*初始化对方节点*/
                            nodeToMtrl(Const.mtrl+'/api/mv/TankMtrlMove/form/'+potId,Const.mtrl+'/api/mv/TankMtrlMove/getListByType', '#oppositeNode', '#oppositeMaterial', '#oppositealias', true);
                        ...
                        //槽罐改名和退库编辑项相同
                            ...
                            tankMove(Const.mtrl+'/api/mv/TankMtrlMove/form/'+potId, 'table tr td:nth-of-type(2)', '#operationType,#ownMaterials,#ownMaterial,#startTime', '#startTime', false);
                        ...
                        //交库||复尺
                            ...
                            tankMove(Const.mtrl+'/api/mv/TankMtrlMove/form/'+potId, 'table tr td:nth-of-type(2)', false, false, false);
                ...
                //关闭
                    ...
                    // tankMove(Const.mtrl+'/api/mv/TankMtrlMove/update'+potId, 'table tr td', '#endTime', '#endTime', false);
