        ...
        init: function () {
            ...
            require(['ztree_my'], function (ZTree) {
                ...
                var orgApiCfg = $.extend(true, {}, {
                    url: Const.mtrl+"/api/mv/Tank/getTankTree",
                    data: {},
                    contentType: 'json'
                }, {});
            ...
            window.pageLoad = function (treeId) {
                ...
                Api.ajaxJson(Const.mtrl + "/api/mv/TankFormula/form", JSON.stringify(data), function (res) {
                    if (res.success) {
                        ...
                        $('#save-btn').unbind('click').on('click',function () {
                            ...
                            if(arr.length==0){
                                ...
                                Api.ajaxForm(Const.mtrl + "/api/mv/TankFormula/save",data, function (result) {
                                    if (result.success) {
