    ...
    var PageModule = {
        dictate: function(){
            ...
            require(['ztree_my'],function(ZTree){
                ...
                function getOption() {
                    ...
                    Api.ajaxJson(Const.aps+'/api/ctrl/BaseDirectiveCZ/getZTree',dat,function(da) {
            ...
            //获取指令分类
            function ajaxkind() {
                Bus.createSelect(Const.admin+'/api/sys/SysDict/type/directiveCassifyType',$('#kind'));
            }
        ...
        order: function(){
            window.updatason = function (node,level){
                ...
                Api.ajaxJson(Const.aps+"/api/ctrl/BaseDirectiveCZ/rightList/",da,function(tableData){
            ...
            function clickButton(level) {
                ...
                $('.btn-delete').click(function () {
                    var id = $(this).parents("tr").find('.i-Checks').attr('id');
                    Bus.deleteItem('确定要删除该指令吗', Const.aps+'/api/ctrl/BaseDirectiveCZ/delete/'+id);
                });
        ...
        check: function(){
            ...
            if(pid){
                ...
                var url = Const.aps+"/api/ctrl/BaseDirectiveCZ/form/";
            ...
            function ajaxproc(){
                ...
                var url=Const.admin+'/api/sys/SysAuthProperty/getAttributeValue/'+_id+'/GXJQ/syswp';
