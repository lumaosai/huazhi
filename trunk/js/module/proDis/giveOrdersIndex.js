    ...
    var PageModule = {
        homePage: function(){
            ...
            require(['ztree_my'],function(ZTree) {
                ...
                getOption();
                reloadZtree('#proc',Const.aps+'/api/ctrl/BaseDirective/getZTree');
                reloadZtree('#kind','Const.aps+/api/ctrl/BaseDirective/getZTree');
                reloadZtree('#grade',Const.aps+'/api/ctrl/BaseDirective/getZTree');
                reloadZtreeinput('#contentParam',Const.aps+'/api/ctrl/BaseDirective/getZTree');
            ...
            function renderclass(){
                //获取当前时间
                Api.ajaxJson(Const.aps+'/api/ctrl/DirectiveIssued/goupList',{},function (data) {
            ...
            function giveorder() {
                ...
                if(str.length>0){
                    ...
                    var url = Const.aps + "/api/ctrl/DirectiveIssued/save/";
            ...
            function connect() {
                ...
                var socket = new SockJS(Const.aps + '/endpointWisely'); //链接SockJS 的endpoint 名称为"/endpointWisely"
