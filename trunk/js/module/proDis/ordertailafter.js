require([cdnDomain+'/js/zlib/app.js'], function(App) {
    ...
    var PageModule = {
        listInit: function(){
            ...
            //获取工序数据
            Bus.createSelect(Const.admin+'/api/sys/SysAuthProperty/getAttributeValue/'+userId+'/GXJQ/syswp',$('#process'),'value','name');
            //获取分类数据
            Bus.createSelect(Const.admin +'/api/sys/SysDict/type/directiveCassifyType',$('#classify'));
            //获取班次数据
            loadShift();
            ...
            require(['Page'],function() {
                window.pageLoad = function () {
                    ...
                    var page = new Page();
                    page.init(Const.aps+"/api/ctrl/DirectiveDetail/queryPage", data, true, function (tableData) {
            ...
            function clickHandler() {
                ...
                $(".btn-operate").click(function (e) {
                    ...
                    Api.ajaxForm(Const.aps+"/api/ctrl/DirectiveIssued/directiveStop",data,function (result) {
                        if(result.success){
                            pageLoad();
                            sendName();
                        }else{
                ...
                $(".btn-end").click(function () {
                    ...
                    Api.ajaxForm(Const.aps+"/api/ctrl/DirectiveIssued/directiveCancel",data,function (result) {
                        if(result.success){
                            pageLoad();
                            sendName();
                        }else{
                ...
                //值班指令
                $("#duty").click(function () {
                    Api.ajaxJson(Const.aps+"/api/ctrl/DirectiveDetail/queryZbzlPage",{},function (result) {
