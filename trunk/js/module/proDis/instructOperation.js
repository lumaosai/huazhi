        ...
        var PageModule = {
            init: function () {
                window.pageLoad = function () {
                    Api.ajaxForm(Const.aps + "/api/ctrl/DirectiveIssued/goupList", {}, function (result) {
                    ...
                    Api.ajaxForm(Const.aps + "/api/ctrl/DirectiveDetail/getReceiveDirective", {}, function (result) {
                        if (result.success) {
            ...
            createTable: function (dataTable) {
                ...
                $(".btn-finish").click(function () {
                    ...
                    Api.ajaxForm(Const.aps + "/api/ctrl/DirectiveIssued/directiveFinish", data ,function (result) {
                        if(result.success){
                            Mom.layMsg("执行成功");
                            Mom.refresh();
                        }else {
