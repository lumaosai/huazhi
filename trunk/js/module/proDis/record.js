require([cdnDomain+'/js/zlib/app.js'], function(App) {
    var PageModule = {
        listInit: function(){
            ...
            require(['Page'],function(){
                ...
                window.pageLoad = function () {
                    ...
                    page.init(Const.aps+"/api/ctrl/ShiftMain/page",data,true,function (tableDta) {
            ...
            //获取班组数据
            function loadGroups(){
                Bus.createSelect(Const.aps+'/api/aps/Groups/list',$('#team'), 'id', 'name');
            }
            //创建table
        ...
        view: function(){
            ...
            var url = Const.aps+"/api/ctrl/ShiftMain/view/"+ id;
