    ...
    var PageModule = {
        ...
        invMListInit: function () {
            require(['Page'], function () {
                ...
                window.pageLoad = function () {
                    ...
                    new Page().init(Const.aps + "/api/aps/manage/page", data, true, function (tableDate,result) {
        ...
        btngather: function (result) {
            ...
            $('.btn-delete').on('click', function () {
                ...
                Bus.deleteItem('请确认是否删除？', Const.aps + '/api/aps/manage/delete', {ids:id});
            });
            //封存
            $('.btn-safesave').on('click', function () {
                ...
                Api.ajaxForm(Const.aps + '/api/aps/manage/equestrationManage', data, function (result) {
                    if (result.success) {
                        Mom.layMsg('封存成功');
                        pageLoad();
                    } else {
                ...
                $(this).unbind('click').on('click', function () {
                    ...
                    if (flagtab == false) {
                        ...
                        if (pageType != 2) {
                            ...
                            Api.ajaxForm(Const.aps + '/api/aps/' + urlArr[tabindex] + '/save', data, function (result) {
                                if (result.success) {
        ...
        getData: function (index, json_, invDate) {
            ...
            Api.ajaxJson(Const.aps + url, {}, function (result) {
                if (result.success) {
        ...
        tabledatagrid: function (statuName, result, jsonItem, json_, index, invDates) {
            ...
            require(['jqGrid_my'], function (jqGridAll) {
                ...
                $('body').off('click', '#save-btn').on('click', '#save-btn', function () {
                    ...
                    var urlArr = ['ManageProcessMtrl', 'ManageMineral', 'ManageReport', 'ManageMtrl', 'ManageYield', 'ManageQuota', 'ManageConsume', 'ManageAO'];
                    Api.ajaxForm(Const.aps + '/api/aps/' + urlArr[index] + '/save', data, function (result) {
                        if (result.success) {
                ...
                $('body').off('click', '#computed-btn').on('click', '#computed-btn', function () {
                    ...
                    Api.ajaxForm(Const.aps + '/api/aps/' + urlArr[index] + '/analysis', data, function (result) {
                        if (result.success) {
        ...
        invMChartInit: function () {
            require(['/js/plugins/echarts/js/echarts.js'], function (echarts) {
                ...
                Api.ajaxForm(Const.aps + '/api/aps' + urlArr[index], data, function (result) {
                    optionLine = {
                        tooltip: {
                            trigger: 'axis'
                        },
