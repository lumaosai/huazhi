require([cdnDomain+'/js/zlib/app.js'], function (App) {
    var PageModule = {
        ...
        updateinit: function () {
            ...
            Api.ajaxForm(Const.admin + '/api/workbench/WorkbenchTileTemplate/form', data, function (result) {
        ...
        renderRContent: function (data, id, results) {
            ...
            var dataMmhtml = {
                ...
                '<td class=""><select class="form-control valid" require="true" name="targer" id="targer"><option value="0">Tab选项卡</option><option value="1">新窗口</option></select>' +
                '</td></tr>',
                /*文本内容*/
        ...
        rendered: function (data, id, results) {
            ...
            Api.ajaxJson(Const.admin + '/api/workbench/WorkbenchTileTemplate/selectAppName', {}, function (result) {
        ...
        dsRender: function (type) {
            Api.ajaxJson(Const.admin + '/api/sys/SysDict/type/workbench_datasource_' + type, {}, function (result) {
                if (result.success) {
        ...
        initWebuploader: function (url, filePicker) {
            require([cdnDomain+'/js/plugins/webUpLoader/webuploader.js'], function (webuploader) {
        ...
        colorChange: function () {
            ...
            Api.ajaxJson(Const.admin + '/api/sys/SysDict/type/workbench_bgcolor_num', {}, function (result) {
        ...
        fontinit: function () {
            ...
            switch (type) {
                case 1:
                    Api.ajaxJson(Const.admin + '/api/sys/SysDict/type/tile_shortcut_icon', {}, function (result) {
                        $('.title').text('快捷入口:');
                        var res = result.rows;
                        $('dl.numberBox').hide();
                    ...
                    break;
                case 2:
                    Api.ajaxJson(Const.admin + '/api/sys/SysDict/type/tile_num_icon', {}, function (result) {
                        var res = result.rows;
                        $('.title').text('数字类:');
